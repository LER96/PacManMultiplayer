...
public class PlayerData : MonoBehaviourPunCallbacks
{
   ...
   // }
    ...
    public void AssignRole()
    {
        ...
        PhotonNetwork.PlayerList[0].SetCustomProperties(new ExitGames.Client.Photon.Hashtable() { { "PowerMode", false } });
        ...
        PhotonNetwork.PlayerList[1].SetCustomProperties(new ExitGames.Client.Photon.Hashtable() { { "PowerMode", false } });
    }
}
